...
/*             for (let i in list) {
    ...
    flowResultsPopup = (title, content, results, e) => {
        ...
        popup.keyEvents[13].handler = popup.collapse;
        popup.keyEvents[27].handler = popup.collapse;
        $("body").append(this.viewMode != "Expanded" ? `<div id="flow-results" style="padding:5px;position:fixed;width:96%;height:96%;top:1%;left:1%;z-index:9000;"></div>` : `<div id="flow-results" style="padding:5px;position:fixed;width:60%;height:30%;top:30%;left:20%;z-index:9000;"></div>`);
